...
@section('container')
    ...
    <div class="p-5 mb-4 bg-light rounded-3 mt-5 animate__animated animate__fadeIn">
    ...
    <div class="input-group rounded mb-5 w-25 animate__animated animate__fadeIn">
        ...
        <div data-aos="fade-up" class="card mb-10 " style="width: 18rem;">
