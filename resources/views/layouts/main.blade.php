    ...
    <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top m-auto">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarButtonsExample">
            ...
            @auth
              <li class="nav-item dropdown animate__animated animate__zoomIn">
                <a
                  ...
                  aria-expanded="false"
                >Welcome, {{ auth()->user()->nama }}  <i class="bi bi-dot"></i>
                  <img
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a class="dropdown-item" href="/profil"><i class="bi bi-person-circle"></i> Profil Saya</a>
                  </li>
      ...
      <footer class="bg-light text-center text-lg-start fixed-bottom">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
          © 2020 Copyright:
          <a class="text-dark" href="uajy.ac.id">Universitas Atma Jaya Yogyakarta</a>
        </div>
        <!-- Copyright -->
      </footer>
